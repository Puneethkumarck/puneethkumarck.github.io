...
This is post 01 of 23. Each post takes one building block (or one hard problem within a block)
and gives you the concept, the design, the hard parts, a code reference, and the failure modes.

```mermaid
graph LR
    subgraph "Part 0 — Foundation"
        P01["01 Why stablecoins<br/>need their own stack"]
        P02["02 The building<br/>blocks map"]
    end

    subgraph "Part I — Chain Layer"
        P03["03 Multi-chain<br/>abstraction"]
        P04["04 Block scanning<br/>& detection"]
        P05["05 Building, signing<br/>& broadcasting"]
        P06["06 Fees, gas<br/>& nonces"]
        P07["07 Stuck tx<br/>& recovery"]
    end

    subgraph "Part II — Money Flows"
        P08["08 Deposit flow"]
        P09["09 Withdrawal flow"]
        P10["10 Sweeps<br/>& treasury"]
    end

    subgraph "Part III — The Core"
        P11["11 Double-entry<br/>ledger"]
        P12["12 Keys &<br/>signing"]
        P13["13 Token<br/>support"]
    end

    subgraph "Part IV — Differentiators"
        P14["14 Multi-tenancy"]
        P15["15 Compliance<br/>pipeline"]
        P16["16 Trade &<br/>FX"]
    end

    subgraph "Part V — Infrastructure"
        P17["17 Kafka event<br/>spine"]
        P18["18 Postgres<br/>for money"]
        P19["19 Resilience"]
        P20["20 Reconciliation"]
    end

    subgraph "Part VI — Quality"
        P21["21 Testing"]
        P22["22 Observability"]
        P23["23 Honest retro"]
    end
...
**You are here: Post 01.** Next up: the building blocks map in detail — every component, its
boundaries, its inputs and outputs, and how they wire together.
